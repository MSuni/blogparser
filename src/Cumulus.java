...
public class Cumulus {
  ...
  FileWriter fw = null;
  String url = "https://www.tripadvisor.com/Search?q=cumulus&geo=189896&pid=3826&typeaheadRedirect=true&redirect=&startTime=1456377062958&uiOrigin=MASTHEAD&returnTo=https%25253A__2F____2F__www__2E__tripadvisor__2E__fi__2F__";
  String hotelname;
  BufferedWriter bw;
  ...
  public void usehtmlunit(int startHotel, int endHotel, String hotelname) {
    ...
    try {
      HtmlPage page = webClient.getPage("https://www.tripadvisor.com/Search?q=cumulus&geo=189896&pid=3826&typeaheadRedirect=true&redirect=&startTime=1456377062958&uiOrigin=MASTHEAD&returnTo=https%25253A__2F____2F__www__2E__tripadvisor__2E__fi__2F__");
	...
	// Going to hotel
	page = webClient.getPage("https://www.tripadvisor.com" + hotelLinks.get(hotelFor).getValue().toString());
	System.out.println("success");
	...
	for (int pageFor = 0; true; pageFor++) {
	  ...
	  if (pageLinks.size() == 0) {
	    ...
	    page = webClient.getPage("https://www.tripadvisor.com" + pageLinks.get(0).getValue().toString());
	  }

	  // if (pageFor != 0) {
	  // page = webClient.getPage("https://www.tripadvisor.com" +
...
//	System.out.println("https://www.tripadvisor.com/" + linkArray.get(i));
//	document = Jsoup.connect("https://www.tripadvisor.com/" + linkArray.get(i)).timeout(60 * 1000).get();
//
//	// Get Page links
...
//
//	  document = Jsoup.connect("https://www.tripadvisor.com/" + linkArray3.get(b)).timeout(60 * 1000).get();
//
//	  // Select reviews
...
//	    System.out.println("https://www.tripadvisor.com/" + linkArray2.get(a));
//	    document = Jsoup.connect("https://www.tripadvisor.com/" + linkArray2.get(a)).timeout(60 * 1000).get();
//
//	    // hae tähdet
//	    // Elements stars =
